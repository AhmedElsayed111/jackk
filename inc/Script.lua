...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/ahmedelsayed111/victorfile/master/GetVersion.txt' ) or 0
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس جاك يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/Sourcejack"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : جاك](https://t.me/Sourcejack)' ,nil,inline,msg.id_)
return false
end
...
if jack.content_.ID == "MessageSticker" then        
...
elseif Text== "حجاج" or Text== "حقاق" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس جاك↯](https://t.me/El_Hagag)")
elseif Text== "البوب" or Text== "بوب" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس جاك↯](https://t.me/ElBOB_x)")
elseif Text== "باسل" or Text== "اباظه" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ](https://t.me/xb_0b)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/Sourcejack) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/Sourcejack)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/Sourcejack)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/Sourcejack)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/Sourcejack)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/Sourcejack) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/Sourcejack)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Sourcejack)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Sourcejack)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Sourcejack)")
