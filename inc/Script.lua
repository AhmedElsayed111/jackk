...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/AhmedElsayed111/snakfile/master/GetVersion.txt' ) or 0
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/
sourcevictor "}}}
send_key(msg.sender_user_id_,'   [قناة سورس : فيكتور](
https://t.me/
sourcevictor)' ,nil,inline,msg.id_)
return false
end
...
elseif Text== "المصري" or Text== "مصري" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس سنيك↯](https://t.me/ElMasry_7)")
