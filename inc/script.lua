...
redis:set(snak.."getidus"..msg.chat_id_, "Photo")
...
return'↯ 𖠲 شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(snak..':addnumberusers')..'】* عضـو .\n' 
end 
end
...
snak..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
snak..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
snak..'addrd:'..msg.sender_user_id_,
snak..'delrdall:'..msg.sender_user_id_,
snak..":ForceSub:"..msg.sender_user_id_,
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/snak.github.io/master/GetVersion.txt' ) or 0
...
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '↯ 𖠲 الاحصائيات . \n\n↯ 𖠲عدد المجموعات المفعله : '..redis:scard(snak..'group:ids')..'\n↯عدد المشتركين في البوت : '..redis:scard(snak..'users')..'\n'
end
---------------[End Function data] -----------------------
...
return '↯ 𖠲عدد سحكاتك ⇜ ❪ '..(redis:get(snak..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
