...
redis:set(victor.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(victor..'lock:join:'..msg.chat_id_,true)
...
redis:del(victor..'lock:join:'..msg.chat_id_)
return "*↯ أهلا عزيزي *"..msg.TheRankCmd.."*\n↯ تم فتح الدخول بالرابط \n*" 
end


local function ivictor(msg,MsgText)

Channel = redis:get(victor..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(victor..'joinchnl') then
...
redis:set(victor.."getidstatus"..msg.chat_id_, "Photo")
redis:set(victor..'lock:kara:'..msg.chat_id_,'off')
return modadd(msg)  
end
...
redis:setex(victor..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(victor..'CheckExpire::'..msg.chat_id_) then 
redis:set(victor..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(victor..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(victor..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(victor..'CheckExpire::'..msg.chat_id_) then 
redis:set(victor..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(victor..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(victor..'CheckExpire::'..msg.chat_id_) then 
redis:set(victor..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(victor..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(victor..'CheckExpire::'..msg.chat_id_) then 
redis:set(victor..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(victor..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(victor..'group:name'..msg.chat_id_) or '')
redis:set(victor..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(victor..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. victor..'')
...
if not msg.Director and redis:get(victor..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(victor..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "↯هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(victor..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(victor..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(victor..'admins:'..msg.chat_id_)
redis:del(victor..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(victor..'owners:'..msg.chat_id_)
redis:del(victor..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(victor..'whitelist:'..msg.chat_id_)
redis:del(victor..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(victor..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(victor..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(victor..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(victor..'linkGroup'..msg.sender_user_id_,300,true)
return '↯ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(victor..'linkGroup'..msg.chat_id_) then 
return "↯ اوه لا يوجد رابط .\n↯لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(victor..'group:name'..msg.chat_id_)
local GroupLink = redis:get(victor..'linkGroup'..msg.chat_id_)
...
local Text = "↯ رابـط الـمـجـمـوعه ↯ \n"..Flter_Markdown(redis:get(victor..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(victor..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(victor..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "↯ عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(victor..':Filter_Word:'..msg.chat_id_)
...
redis:del(victor..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(victor..'welcome:msg'..msg.chat_id_) then 
return "↯ اوه هنالك خطأ .\n↯ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(victor..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(victor..':Hussain:'..msg.chat_id_)
redis:del(victor..':Hussain:'..msg.chat_id_)
...
if not msg.Kara then return "✲¦ هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local NumMnsha = redis:scard(victor..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(victor..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(victor..'banned:'..msg.chat_id_)
if #list == 0 then return "*↯ لا يوجد مستخدمين محظورين  *" end
message = '↯ قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(victor..'banned:'..msg.chat_id_)
return "↯أهلا عزيزي "..msg.TheRankCmd.."   \n↯  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(victor..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "↯ لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(victor..'is_silent_users:'..msg.chat_id_)
...
redis:del(victor..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "↯هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(victor..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(victor..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "↯هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(victor..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(victor..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(victor..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(victor..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(victor..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(victor..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(victor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(victor..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(victor..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(victor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(victor.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(victor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(victor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(victor..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(victor..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(victor..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(victor..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(victor..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(victor..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(victor..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(victor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "↯تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '↯  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(victor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(victor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "↯عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(victor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(victor..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "↯عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(victor..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(victor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(victor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(victor..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(victor..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(victor..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(victor..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(victor..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(victor..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(victor..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "↯هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(victor..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "↯هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(victor..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(victor..'welcome:msg'..msg.chat_id_))
else 
return "↯أهلا عزيزي "..msg.TheRankCmd.."  \n↯ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(victor..'group:ids')
...
local pv = redis:smembers(victor..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(victor..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(victor..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[↯ اهلا انا بوت]]..redis:get(victor..':NameBot:')..[[ .
...
if not msg.SudoUser then return "↯ 𖠲هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(victor..'group:ids',MsgText[2]) then
local name_gp = redis:get(victor..'group:name'..MsgText[2])
...
return redis:get(victor..":TEXT_SUDO") or '↯ لا توجد كليشه المطور .\n↯ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه" then
if not msg.SudoUser then return"↯ 𖠲هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(victor..'lock_brod') then 
return "↯ 𖠲 الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(victor..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(victor..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(victor..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(victor..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:del(victor..'welcom:witting'..msg.sender_user_id_,
victor..'rulse:witting'..msg.sender_user_id_,
victor..'rulse:witting'..msg.sender_user_id_,
victor..'name:witting'..msg.sender_user_id_,
victor..'about:witting'..msg.sender_user_id_,
victor..'fwd:all'..msg.sender_user_id_,
victor..'fwd:pv'..msg.sender_user_id_,
victor..'fwd:groups'..msg.sender_user_id_,
victor..'namebot:witting'..msg.sender_user_id_,
victor..'addrd_all:'..msg.sender_user_id_,
victor..'delrd:'..msg.sender_user_id_,
victor..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
victor..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
victor..'addrd:'..msg.sender_user_id_,
victor..'delrdall:'..msg.sender_user_id_,
victor..":ForceSub:"..msg.sender_user_id_,
victor..'text_sudo:witting'..msg.sender_user_id_,
victor..'addrd:'..msg.chat_id_..msg.sender_user_id_,
victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/victor.github.io/master/GetVersion.txt' ) or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' *╿* يوجد تحديث جديد الان \n*╽* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(victor..":VERSION",GetVerison)
return false
else
...
return 'ٴ𐄬 اصدار سورس فيكتور : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس فيكتور يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/sourcevictor"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : فيكتور](https://t.me/sourcevictor)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '↯ 𖠲 الاحصائيات . \n\n↯ 𖠲عدد المجموعات المفعله : '..redis:scard(victor..'group:ids')..'\n↯عدد المشتركين في البوت : '..redis:scard(victor..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام" then
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(victor..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "↯ حسننا الان ارسل كلمة الرد العام .\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(victor..'replay:'..msg.chat_id_)
local photo 	= redis:exists(victor..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(victor..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(victor..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(victor..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(victor..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(victor..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(victor..'replay:'..msg.chat_id_,victor..'replay_photo:group:'..msg.chat_id_,victor..'replay_voice:group:'..msg.chat_id_,
victor..'replay_animation:group:'..msg.chat_id_,victor..'replay_audio:group:'..msg.chat_id_,victor..'replay_sticker:group:'..msg.chat_id_,victor..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(victor..'replay:all')
local photo 	= redis:exists(victor..'replay_photo:group:')
local voice 	= redis:exists(victor..'replay_voice:group:')
local imation 	= redis:exists(victor..'replay_animation:group:')
local audio 	= redis:exists(victor..'replay_audio:group:')
local sticker 	= redis:exists(victor..'replay_sticker:group:')
local video 	= redis:exists(victor..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(victor..'replay:all',victor..'replay_photo:group:',victor..'replay_voice:group:',victor..'replay_animation:group:',victor..'replay_audio:group:',victor..'replay_sticker:group:',victor..'replay_video:group:')
...
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(victor..'delrdall:'..msg.sender_user_id_,true) 
...
redis:set(victor..'delrd:'..msg.sender_user_id_,true)
...
local names  	= redis:hkeys(victor..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(victor..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(victor..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(victor..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(victor..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(victor..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(victor..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(victor..'replay:all')
local photo 	= redis:hkeys(victor..'replay_photo:group:')
local voice 	= redis:hkeys(victor..'replay_voice:group:')
local imation 	= redis:hkeys(victor..'replay_animation:group:')
local audio 	= redis:hkeys(victor..'replay_audio:group:')
local sticker 	= redis:hkeys(victor..'replay_sticker:group:')
local video 	= redis:hkeys(victor..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '↯ 𖠲لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "↯ 𖠲هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(victor..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "↯ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"↯هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(victor..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "↯ 𖠲هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n↯ " end
if not redis:get(victor..'lave_me'..msg.chat_id_) then 
return "↯ 𖠲أهلا عزيزي "..msg.TheRankCmd.."\n↯ المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(victor..'lave_me'..msg.chat_id_) 
return "↯أهلا عزيزي "..msg.TheRankCmd.."\n↯ تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "↯ 𖠲هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n↯ " end
if redis:get(victor..'lave_me'..msg.chat_id_) then 
return "↯ 𖠲أهلا عزيزي "..msg.TheRankCmd.."\n↯ المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(victor..'lave_me'..msg.chat_id_,true)  
...
𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐈𝐂𝐓𝐎𝐑  𖤝
┈ ┈ ┈ ┈ ┈ ┈ ┈
✧ 𝙳𝙴𝚅1 ┆ [ ˹ 𝙴𝙻𝙱𝙾𝙱𖤝.[(t.me/elbob_x)
✧ 𝙳𝙴𝚅2 ┆ [ ˹𝙷𝙰𝙶𝙰𝙶𖤝.](t.me/el_Hagag) 
✧ 𝙲𝙷   ┆ [˹ 𝚅𝙸𝙲𝚃𝙾𝚁𖤝.](t.me/sourcevictor)
┈ ┈ ┈ ┈ ┈ ┈ ┈
]]
end
...
if not msg.SudoBase then return"↯هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(victor..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"↯ 𖠲هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(victor..":UserNameChaneel")
if UserChaneel then
...
if redis:get(victor..'welc'..msg.chat_id_) == 'on' then
...
local hash = victor..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(victor..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(victor..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(victor..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'↯ اهلا عزيزي \n↯ تم تثبيت الامر الجديد\n✓')
redis:del(victor..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end
...
redis:setex(victor..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(victor..'CmD:'..msg.chat_id_,cmd)
redis:srem(victor..'CmDlist:'..msg.chat_id_,cmd)
...
if not msg.Kara then return "↯ 𖠲هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(victor..'CmD:'..msg.chat_id_)
redis:del(victor..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"↯ 𖠲 اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "↯ 𖠲هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(victor..'CmDlist:'..msg.chat_id_)
local t = '↯ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(victor..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(victor..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(victor..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(victor..'welc'..msg.chat_id_,'off')
redis:del(victor..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,victor)   
if victor.content_.ID == "MessageSticker" then        
local bd = victor.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(victor..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(victor..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*↯ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(victor..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس فيكتور\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
...
redis:sadd(victor..'users',msg.sender_user_id_)
if redis:get(victor..'lock_service') then 
text = [[↯ أهلاً انا بوت   []]..redis:get(victor..':NameBot:')..[[] 🗽
...
ــــــــــــــــــــــــــــــــ victor 𖠲ـــــــــــــــــــــــــ
...
ـــــــــــــــــــــــــــــــــvictorــــــــــــــــــــــــ
 ↯ مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
end
...
local MSG_ID = (redis:get(victor.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(victor..'lock_twasel') then
...
redis:setex(victor.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(victor..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(victor..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(victor..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n↯ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(victor..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه صوره للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(victor..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه بصمه صوت للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(victor..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه متحركه للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(victor..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه فيديو للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(victor..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه للصوت للرد بنجاح\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(victor..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(victor..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(victor..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(victor..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ↯ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(victor..'replay_photo:group:',klma,photo_id)
redis:del(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه صوره للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(victor..'replay_voice:group:',klma,voice_id)
redis:del(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه بصمه صوت للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(victor..'replay_animation:group:',klma,animation_id)
redis:del(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه متحركه للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(victor..'replay_video:group:',klma,video_id)
redis:del(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه فيديو للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(victor..'replay_audio:group:',klma,audio_id)
redis:del(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه للصوت للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(victor..'replay_sticker:group:',klma,sticker_id)
redis:del(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(victor..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(victor..":ForceSub:"..msg.sender_user_id_)
...
redis:set(victor..":UserNameChaneel",msg.text)
...
if redis:get(victor..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(victor..'namebot:witting'..msg.sender_user_id_)
redis:set(victor..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"↯ تم تغير اسم البوت  .\n↯ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(victor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(victor..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(victor..'replay_photo:group:',msg.text)
redis:hdel(victor..'replay_voice:group:',msg.text)
redis:hdel(victor..'replay_animation:group:',msg.text)
redis:hdel(victor..'replay_audio:group:',msg.text)
redis:hdel(victor..'replay_sticker:group:',msg.text)
redis:hdel(victor..'replay_video:group:',msg.text)
redis:setex(victor..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"↯ جيد , يمكنك الان ارسال جوا ب الردالعام \n↯ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(victor..'delrdall:'..msg.sender_user_id_) then
redis:del(victor..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(victor..'replay:all',msg.text)
local photo =redis:hget(victor..'replay_photo:group:',msg.text)
local voice = redis:hget(victor..'replay_voice:group:',msg.text)
local animation = redis:hget(victor..'replay_animation:group:',msg.text)
local audio = redis:hget(victor..'replay_audio:group:',msg.text)
local sticker = redis:hget(victor..'replay_sticker:group:',msg.text)
local video = redis:hget(victor..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'↯هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(victor..'replay:all',msg.text)
redis:hdel(victor..'replay_photo:group:',msg.text)
redis:hdel(victor..'replay_voice:group:',msg.text)
redis:hdel(victor..'replay_audio:group:',msg.text)
redis:hdel(victor..'replay_animation:group:',msg.text)
...
if redis:get(victor..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(victor..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(victor..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "↯ تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(victor..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(victor..'welcom:witting'..msg.sender_user_id_) 
redis:set(victor..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"↯ تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(victor..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(victor..'rulse:witting'..msg.sender_user_id_) 
redis:set(victor..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'↯ مرحبآ عزيزي\n↯ تم حفظ القوانين بنجاح .\n↯ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(victor..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(victor..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(victor..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(victor..'linkGroup'..msg.sender_user_id_,link) 
redis:set(victor..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'↯ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(victor..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(victor..'about:witting'..msg.sender_user_id_) 
...
if redis:get(victor..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(victor..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(victor..'users')  
local groups = redis:smembers(victor..'group:ids')
...
if redis:get(victor..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(victor..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(victor..'users')
if #pv >= 300 then
...
if redis:get(victor..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(victor..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(victor..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(victor..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(victor..':WELCOME_BOT'),[[↯أهلاً انا بوت ]]..redis:get(victor..':NameBot:')..[[
...
if msg.forward_info and redis:get(victor..'fwd:'..msg.sender_user_id_) then
redis:del(victor..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(victor..'users')
local groups = redis:smembers(victor..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(victor..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(victor..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(victor..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(victor..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(victor..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(victor..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(victor..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(victor..'replay:'..msg.chat_id_,msg.text)
redis:hdel(victor..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(victor..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(victor..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(victor..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(victor..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(victor..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(victor..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"↯ جيد , يمكنك الان ارسال جواب الرد \n↯ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(victor..'delrd:'..msg.sender_user_id_) then
redis:del(victor..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(victor..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(victor..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(victor..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(victor..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(victor..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(victor..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(victor..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'↯هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(victor..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(victor..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(victor..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(victor..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(victor..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(victor..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(victor..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(victor..'welcome:msg'..msg.chat_id_) or "↯ اهلاً عزيزي {الاسم}\n↯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n↯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(victor..'rulse:msg'..msg.chat_id_) or "↯ مرحباً عزيري القوانين كلاتي .\n↯ ممنوع نشر الروابط\n↯ ممنوع التكلم او نشر صور اباحيه\n↯ ممنوع  اعاده توجيه\n↯ ممنوع التكلم بالسياسة\n↯ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(victor..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(victor..'welcome:msg'..msg.chat_id_) or "↯ اهلن بك عزيزي {الاسم}\n↯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n↯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(victor..'rulse:msg'..msg.chat_id_) or "↯ مرحباً عزيري القوانين كلاتي .\n↯ ممنوع نشر الروابط\n↯ ممنوع التكلم او نشر صور اباحيه\n↯ ممنوع  اعاده توجيه\n↯ ممنوع التكلم بالسياسة\n↯ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(victor..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(victor..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(victor..'welcome:get'..msg.chat_id_)
end
redis:setex(victor..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(victor..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(victor..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_victor = (redis:get(victor..'num_msg_victor'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_victor) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(victor..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"↯ العضو » "..USERNAME.."\n↯ قمـت بتكرار اكثر مـن "..NUM_MSG_victor.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(victor..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(victor..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(victor..'lock_woring'..msg.chat_id_) and not redis:get(victor..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(victor..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(victor..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(victor..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'↯ لا يمكنني مسح الرساله المخالفه .\n↯ لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(victor..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(victor..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(victor..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(victor..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(victor..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(victor..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(victor..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(victor..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(victor..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(victor..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(victor..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(victor..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(victor..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(victor..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(victor..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(victor..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(victor..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(victor..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(victor..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(victor..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(victor..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(victor..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(victor..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(victor..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(victor..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(victor..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(victor..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(victor..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(victor..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(victor..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(victor..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(victor..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(victor..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(victor..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(victor..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "البوب" or Text== "البوب" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ♕](https://t.me/elbob_x)")
elseif Text== "ملك التلجرام" or Text== "مطور السورس" then return  sendMsg(msg.chat_id_,msg.id_,"[البوب البوب ♧](https://t.me/elbob_x)")
...
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 مرحباً عزيزي\nٴ𐄬 هذي اوامر التسليه:  \nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 رفع › تنزيل ❬ متوحد ❭\nٴ𐄬 رفع › تنزيل ❬ وتكه ❭\nٴ𐄬 رفع › تنزيل ❬ غبي ❭\nٴ𐄬 رفع › تنزيل ❬ كلب ❭\nٴ𐄬 رفع › تنزيل ❬ حمار ❭\nٴ𐄬 رفع › تنزيل ❬ زوجتي ❭\nٴ𐄬 رفع › تنزيل ❬ متوحده ❭\nٴ𐄬 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\nٴ𐄬 ❬ طلاق ❭ › ❬ زواج ❭\nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬")
 ...
 elseif Text== "ايديي" or Text=="ايدي ☆" then 
  ...
  elseif Text=="ابي رابط الحذف" or Text=="ابي رابط حذف" or Text=="رابط حذف" or Text=="رابط الحذف" or Text=="رابط بوب" then
  return sendMsg(msg.chat_id_,msg.id_,[[
...
❆رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "بوب" or Text== " بوب " or Text=="بوب" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[.](https://t.me/elbob_x) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/elbob_x")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..victor..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(victor..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(victor..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(victor..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(victor..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(victor..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(victor..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(victor..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(victor..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(victor..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'↯ انتهى الاشتراك في احد المجموعات .\n↯ المجموعه : '..FlterName(redis:get(victor..'group:name'..msg.chat_id_))..'.\n↯ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'↯ انتهى الاشتراك البوت.\n↯ سوف اغادر المجموعه فرصه سعيده .\n↯ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(victor..'ExpireDate:'..msg.chat_id_) / 86400)
