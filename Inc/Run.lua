...
SUDO_USER = redis:hgetall(snak..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(snak..':WELCOME_BOT'),[[•~مـرحبآ آنآ بوت آسـمـي ]]..redis:get(snak..':NameBot:')..[[•~آختصـآصـي حمـآيه‌‏ آلمـجمـوعآت
