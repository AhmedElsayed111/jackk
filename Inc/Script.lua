...
return '• اصدار سورس سـنـيـك : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سـنـيـك يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : سـنـيـك](https://t.me/Sourcesnak)' ,nil,inline,msg.id_)
return false
end
